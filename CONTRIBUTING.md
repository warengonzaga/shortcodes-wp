...
This project and everyone participating in it is governed by the Shortcodes WP [Code of Conduct](https://github.com/warengonzaga/shortcodes-wp/blob/master/code_of_conduct.md). By participating, you are expected to uphold this code. Please report unacceptable behavior to <opensource@warengonzaga.com>.
...
Answering a question in [Discussions](https://github.com/warengonzaga/shortcodes-wp/discussions) is one of the easiest ways to start contributing.
